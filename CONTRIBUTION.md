...
## Code Documentation
I order to be able rendering documentation for the code, we chose to document the cod ein[http://typedoc.org/guides/doccomments/](typedoc). The documentation can be generated by using the following command
